function calculated_dataStructure = fcn_DataClean_calculateSigmas_GPS(dataStructure, varargin)
...
% OUTPUTS:
%
%      calculated_dataStructure: a data structure contains calculated GPS
%      velocities
%
% DEPENDENCIES:
%
