% script_test_fcn_DataClean_checkDataTimeConsistency_GPS.m
% tests fcn_DataClean_checkDataTimeConsistency_GPS.m
...
[flags, offending_sensor] = fcn_DataClean_checkDataTimeConsistency_GPS(dataStructure);
fprintf(1,'\nCASE 1: Done!\n\n');
