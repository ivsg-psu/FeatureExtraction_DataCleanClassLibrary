function [flags,offending_sensor,return_flag] = fcn_DataClean_checkDataStrictlyIncreasing(dataStructure, field_name, varargin)
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataClean_checkDataStrictlyIncreasing
