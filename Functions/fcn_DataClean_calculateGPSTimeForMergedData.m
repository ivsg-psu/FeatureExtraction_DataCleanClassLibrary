...
% fcn_DataClean_calculateGPSTimeForMergedData
% Calculate GPS time for nmea sentences without GPS time
% FORMAT:
%
%      matched_GPS_Time_fixed = fcn_DataClean_calculateGPSTimeForMergedData(ROS_Time,GPS_Time,centiSeconds,offset_between_GPSTime_and_ROSTime)
%
% INPUTS:
%
