function LiDAR_Data_Output = fcn_LaneDetection_filterPointCloudInROI(LiDAR_Data,ROI)

% FCN_LANEDETECTION_FILTERPOINTCLOUDINROI
%
...
function [filtered_PointCloud_cell, valid_indices_cell] = fcn_Internal_filterPointInXYZ(LiDAR_PointCloud,x_limits, y_limits, z_limits)
