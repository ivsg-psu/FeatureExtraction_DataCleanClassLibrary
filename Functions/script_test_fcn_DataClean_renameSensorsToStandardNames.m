...
assert(isfield(updated_dataStructure,'DIAGNOSTIC_TrigBox_RearTop'));
...
assert(isfield(updated_dataStructure,'DIAGNOSTIC_Sparkfun_RearLeft'));
assert(isfield(updated_dataStructure,'DIAGNOSTIC_Sparkfun_RearRight'));
assert(isfield(updated_dataStructure,'TRANSFORM_ROS_Rear'));
assert(isfield(updated_dataStructure,'GPS_SparkFun_RearRight'));
assert(isfield(updated_dataStructure,'GPS_SparkFun_RearLeft'));
