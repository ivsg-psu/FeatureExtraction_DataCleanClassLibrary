function time_offsets = fcn_DataClean_grabTimeOffsetForVelodyneLiDAR(dataStructure)


%% Pull PointCloud Cell from Velodyne LiDAR
[cell_array_PointCloud,LiDAR_Names_PointCloud] = fcn_DataClean_pullDataFromFieldAcrossAllSensors(dataStructure, 'PointCloud','lidar');
