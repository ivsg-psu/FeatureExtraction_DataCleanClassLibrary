...
% FORMAT:
%
%      [flags,offending_sensor] = fcn_DataClean_checkDataTimeConsistency_TriggerBox(dataStructure, (fid), (plotFlags))
%
% INPUTS:
%
...
[ROS_Time_CellArray,~] = fcn_DataClean_pullDataFromFieldAcrossAllSensors(dataStructure,'ROS_Time','Trigger_Raw');
