function GPSfromROS_Time = fcn_DataClean_predictGPSTimeFromROSTime(mean_fit, filtered_median_errors, ROS_Time, varargin)
...
% FORMAT:
%
%      GPSfromROS_Time = fcn_DataClean_predictGPSTimeFromROSTime(...
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataClean_predictGPSTimeFromROSTime
