...
[flags,offending_sensor] = fcn_DataClean_checkTimeSamplingConsistency(initial_test_structure,field_name, verificationTypeFlag, flags, sensors_to_check, (fid),(fig_num));
...
% FAIL
verificationTypeFlag = 0; 
[flags,offending_sensor] = fcn_DataClean_checkTimeSamplingConsistency(modified_test_structure,field_name, verificationTypeFlag, flags, sensors_to_check, (fid),(fig_num));
