...
function diagnostic_encoder = fcn_DataClean_loadRawData_diagnostic_encoder(data_structure,data_source)

if strcmp(data_source,'mat_file')
    diagnostic_encoder.rosbagTimestamp  = data_structure.Time';
    diagnostic_encoder.data             = data_structure.data; 
else
