...
try
    Hemisphere = fcn_DataClean_loadRawDataFromFile_Hemisphere(data_struct.Hemisphere_DGPS,data_source,flag_do_debug);
...
try
    GPS_Novatel = fcn_DataClean_loadRawDataFromFile_Novatel_GPS(data_struct.GPS_Novatel,Hemisphere,data_source,flag_do_debug);
...
try
    GPS_Garmin = fcn_DataClean_loadRawDataFromFile_Garmin_GPS(data_struct.Garmin_GPS,data_source,flag_do_debug);
...
try
    IMU_Novatel = fcn_DataClean_loadRawDataFromFile_IMU_Novatel(data_struct.Novatel_IMU,data_source,flag_do_debug);
...
try
    IMU_ADIS = fcn_DataClean_loadRawDataFromFile_IMU_ADIS(data_struct.adis_IMU_data,data_source,flag_do_debug);
...
try
    Input_Steering = fcn_DataClean_loadRawDataFromFile_Input_Steering(data_struct.Steering_angle,data_source,flag_do_debug);
...
try
    Encoder_RearWheels = fcn_DataClean_loadRawDataFromFile_Encoder_RearWheels(data_struct.Raw_encoder,GPS_Novatel, data_source,flag_do_debug);
...
try
    Lidar = fcn_DataClean_loadRawDataFromFile_Lidar(data_struct.Lidar,data_source,flag_do_debug);
    rawData.Lidar = Lidar;
catch
