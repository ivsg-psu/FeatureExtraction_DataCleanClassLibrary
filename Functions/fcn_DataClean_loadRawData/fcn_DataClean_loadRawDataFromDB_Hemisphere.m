...
if strcmp(datatype,'gps')
    ...
    secs = datatable.seconds;
    nsecs = datatable.nanoseconds;
    ...
    Hemisphere_DGPS.ROS_Time           = datatable.time;  % This is the ROS time that the data arrived into the bag
    ...
    Hemisphere_DGPS.Npoints            = len(field_data_struct.id);  % This is the number of data points in the array
    ...
    Hemisphere_DGPS.Altitude           = datatable.altitude;  % The altitude above sea level [m]
