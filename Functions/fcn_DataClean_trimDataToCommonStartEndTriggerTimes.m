...
% FORMAT:
%
%      trimmed_dataStructure = fcn_DataClean_trimDataToCommonStartEndTriggerTimes(dataStructure,(fid))
%
% INPUTS:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataClean_trimDataToCommonStartEndTriggerTimes
...
% -- wrote the code originally based on fcn_DataClean_trimDataToCommonStartEndGPSTimes
...
[~,sensor_names] = fcn_DataClean_pullDataFromFieldAcrossAllSensors(dataStructure, 'Trigger_Time');
